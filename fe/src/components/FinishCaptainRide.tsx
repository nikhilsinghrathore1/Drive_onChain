...
const FinishCaptainRide = () => {
  return (
               <div className='w-full  h-fit  pt-1 relative rounded-t-2xl bg-white flex flex-col px-2 justify-between pb-10 '> 

               <div className="w-full pt-3 mb-10 h-fit  flex justify-center  text-4xl text-gray-500   ">
               <FaChevronDown/>
               </div>
               <div>

                  <h1 className="text-[2rem] mb-8 px-2 font-bold tracking-tight ">Finish this Ride</h1>
               ...
               <div className="w-full bg-yellow-400 py-4 border-[1px] mt-5 mb-8 border-black/30  rounded-xl flex items-center justify-between px-5">
                  ...
                  <div className="flex items-center gap-5 w-full  px-8 mt-5 mb-8">
               ...
               <div>
                  ...
                  <div className=" w-full rounded-lg active:bg-green-500 text-2xl mt-2 font-medium py-3 bg-green-400 flex justify-center items-center text-white">
